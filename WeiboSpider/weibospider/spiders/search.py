...
class SearchSpider(Spider):
    ...
    def start_requests(self):
        """爬虫入口 """
        keywords = ['蔚来回应试驾致母子一死一伤'] #蔚来回应试驾致母子一死一伤
        start_time = "2023-02-13-0"  # 格式为 年-月-日-小时, 2022-10-01-0 表示2022年10月1日0时
        end_time = "2023-03-29-12"  # 格式为 年-月-日-小时, 2022-10-07-23 表示2022年10月7日23时
        is_search_with_specific_time_scope = False  # 在指定的时间区间进行推文搜索
        is_sort_by_hot = True  # 按照热度排序,默认按照时间
        for keyword in keywords:
            if is_search_with_specific_time_scope:
                ...
                url = f"https://s.weibo.com/weibo?q={keyword}&Refer=realtime_weibo"
            if is_sort_by_hot:
                url += " " #&xsort=hot
